...
export async function updateVacationPeriod(vacationId, startDate, endDate) {
	return apiRequest(
		`/api/vacations/${vacationId}`,
		FETCH_OPTIONS(FETCH_METHODS.PUT, CONTENT_TYPES.JSON, JSON.stringify({ startDate, endDate }))
	);
}
